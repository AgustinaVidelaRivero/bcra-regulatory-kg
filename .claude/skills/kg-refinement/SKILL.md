...
**Alcance por grafo (regla vigente post-gate U5, reemplaza a la restricción transitoria):** Sobre la familia v2/v3, el veredicto del verificador validado (`docs/lectura_gate_u5.md`) habilita el diagnóstico de entradas de backlog; la adjudicación del laudo final y toda aplicación siguen siendo humanas. Fuera de la familia v2/v3, el verificador sigue exploratorio. La copia de trabajo `run_3_refinamiento/`, la calibración del Paso 3 y el baseline del Paso 5 son run_3-específicos; nada de eso se reutiliza sobre v2/v3.
