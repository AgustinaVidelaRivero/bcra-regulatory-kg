...
# URLs verificadas a mayo 2026.
TEXTOS_ORDENADOS: dict[str, str] = {
    # --- Núcleo del piloto (4 originales) ---
    "marco_normativo": (
    ...
    # --- Extensión: TOs con referencia cruzada directa al núcleo ---
    "previsiones_minimas_incobrabilidad": (
        "https://www.bcra.gob.ar/archivos/Pdfs/texord/t-prevmi.pdf"
    ),
    "garantias": (
        "https://www.bcra.gob.ar/pdfs/texord/t-garant.pdf"
    ),
    "lineamientos_gestion_riesgos": (
        "https://www.bcra.gob.ar/pdfs/texord/t-lingeef.pdf"
    ),
    "proteccion_usuarios_servicios_financieros": (
        "https://www.bcra.gob.ar/archivos/Pdfs/texord/t-pusf.pdf"
    ),
    "evaluaciones_crediticias": (
        "https://www.bcra.gob.ar/pdfs/texord/t-evacre.pdf"
    ),
    "capitales_minimos": (
        "https://www.bcra.gob.ar/pdfs/texord/t-capmin.pdf"
    ),
    "proveedores_no_financieros_credito": (
        "https://www.bcra.gob.ar/archivos/Pdfs/texord/t-apnf.pdf"
    ),
    "centrales_de_informacion": (
        "https://www.bcra.gob.ar/archivos/Pdfs/texord/t-ceninf.pdf"
    ),
    "graduacion_credito": (
        "https://www.bcra.gob.ar/archivos/Pdfs/texord/t-gracre.pdf"
    ),
    # --- Extensión: TOs periféricos pero del mismo cluster temático ---
    "politica_de_credito": (
        "https://www.bcra.gob.ar/pdfs/texord/t-polcre.pdf"
    ),
    "cesion_de_cartera": (
        "https://www.bcra.gob.ar/archivos/Pdfs/texord/t-cescar.PDF"
    ),
    "lineamientos_gobierno_societario": (
        "https://www.bcra.gob.ar/archivos/Pdfs/Texord/t-lingob.pdf"
    ),
}
