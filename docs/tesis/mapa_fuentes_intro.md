...
| 21 | Ejemplo de la Figura 1 («de la norma al grafo»): 6 nodos, 5 aristas, 3 resaltadas «remite a» | `docs/tesis/figuras/LEEME_figura_norma_a_grafo.md` §§6–7 y §10 (caso y correspondencia verificados contra `salida_r1/kg.json`) | `2f511ba` (LEEME whitelisteado acá) |
