...
- [ ] B5.7 (I) Issue #6: documento de costos con tarifas reales + caching + experimento óptimo dentro de USD 200 (con B5.5). Laudo D4 warm-then-parallel (throughput: ~13 s/unidad → ~29 h secuenciales para 8.010). **Incluye (re-laudo 06/09): re-presupuesto explícito de los no-RI reconocidos por B5.8 antes de que la tanda 2 los gaste** (base informativa: tabla de los 31, cota superior ~USD 69,73).
