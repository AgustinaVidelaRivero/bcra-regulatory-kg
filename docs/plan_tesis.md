...
| P-3 | **PROMESA** de 2.2.2 al capítulo 5: el conjunto de evaluación distingue preguntas de dato directo de preguntas de varios saltos; los tres indicadores de cita (existente, fundada, al punto de referencia) se reportan | Conjunto EV2 `data/experiment/exploracion/ev2_fidelidad/preguntas_ev2_fidelidad.json` (sha256 `1d587336…`, 40 preguntas con claves `id`, `to`, `to_nombre`, `pregunta`, `gold{ancla, criterios}`): **clasificación no presente en el conjunto al 20/09; decisión de la autora pendiente**. Indicadores de cita: NO ENCONTRADO en este plan al 20/09 (ninguna fila los nombra) [SUPERADO el mismo 20/09 por el laudo 5: U-CITA-2 CERRADA 18/09, registrada bajo B6.3, y componente (e) de B6.3] | texto tomado del mandato U-PLAN-MT del 20/09; pendiente de verificar contra main.tex cuando se sincronice | **PROMESA** — la hace 2.2.2; la debe el capítulo 5. **Laudos 4 y 5 del 20/09/2026:** la clasificación de preguntas queda cubierta por **U-EV2-TIPO** (sub-ítem de B6.3, regla escrita antes de leer, archivo aparte del JSON sellado) y los tres indicadores de cita por **U-CITA-2** (cerrada 18/09) y el componente (e) de B6.3 |
