...
- [~] **U-EXP5** (I, $0) **FASE DE INVESTIGACIÓN DESPACHADA 15/09** a instancia ejecutora, mandato aprobado por la autora; solo lectura, sin escrituras en el repo, freno en el documento; precedentes externos solo leídos en sesión con URL o DOI y marca EXTERNO — NO VERIFICADO POR LA MESA. — investigación de metodología de evaluación del pipeline POR ETAPAS
