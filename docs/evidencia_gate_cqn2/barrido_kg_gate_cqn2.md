...
## ANEXO K-E2 — D1 + ranking de los nodos de K-E contra los pasos 2, 3 y 11 de CQN2-011

Segundo barrido del circuito (corrido tras K-A..K-I, antes de la adjudicación externa).
D1 = `evaluar_alcanzabilidad` REAL con los insumos de la traza CQN2-011; evidencia
reducida con `_evidencia_d1_reducida` de la capa congelada. Ranking con `buscar_nodos`
REAL y las consultas VERBATIM de la traza (límites de runtime).

### D1


**Excepcion_quedan_exceptuadas_las_importaciones_realizadas_por_empresas_que_presten_servici**: alcanzable=False

```json
{
 "alcanzable": false,
 "n_consultas_simuladas": 105,
 "consultas_en_top10": [],
 "mejor_rank": 25
}
```

**Restriccion_las_posiciones_arancelarias_de_los_bienes_no_correspondan_a_aquellas_comprendida**: alcanzable=False
...
**Restriccion_posiciones_arancelarias_ncm_8802_11_00_8802_12_10_8802_12_90_8802_20_10_8802_20_**: alcanzable=True
...
```json
{
 ...
 "consultas_en_top10": [
  ...
  {
   "consulta": "aeronave partida 8802",
   "origen": "ngrama_pregunta",
   "tokens_fuera_vocabulario": [],
   "total_con_match": 6,
   "rank": 3,
...
**EntidadFinanciera_empresa_de_aeronavegacion**: alcanzable=False
...
**Operacion_importacion_de_bienes_aeronaves**: alcanzable=True
...
```json
{
 ...
 "consultas_en_top10": [
  {
   "consulta": "pendiente importacion",
   "origen": "ngrama_pregunta",
   "tokens_fuera_vocabulario": [],
   "total_con_match": 39,
   "rank": 3,
  ...
  {
   "consulta": "aduanero pendiente importacion",
   "origen": "ngrama_pregunta",
   "tokens_fuera_vocabulario": [],
   "total_con_match": 59,
   "rank": 5,
  ...
  {
   "consulta": "pendiente importacion aeronave",
   "origen": "ngrama_pregunta",
   "tokens_fuera_vocabulario": [],
   "total_con_match": 39,
   "rank": 3,
  ...
  {
   "consulta": "importacion aeronave partida",
   "origen": "ngrama_pregunta",
   "tokens_fuera_vocabulario": [],
   "total_con_match": 34,
   "rank": 3,
...
### Ranking (pasos 2, 3, 11 de CQN2-011)


- **paso 2** — `importación aeronave NCM 8802 pago a la vista` · límite 10:
    - Excepcion_quedan_exceptuadas_las_importaciones_realizadas_por_empresas_que_presten_servici: NO en top-10 · global — de 50 (top-50 del harness)
    - Restriccion_las_posiciones_arancelarias_de_los_bienes_no_correspondan_a_aquellas_comprendida: NO en top-10 · global — de 50 (top-50 del harness)
    - Restriccion_posiciones_arancelarias_ncm_8802_11_00_8802_12_10_8802_12_90_8802_20_10_8802_20_: posición 7 de 10 · global 7 de 50 (top-50 del harness)
    - EntidadFinanciera_empresa_de_aeronavegacion: NO en top-10 · global — de 50 (top-50 del harness)
    - Operacion_importacion_de_bienes_aeronaves: NO en top-10 · global — de 50 (top-50 del harness)

- **paso 3** — `MiPyMe importación aeronave excepción` · límite 10:
    - Excepcion_quedan_exceptuadas_las_importaciones_realizadas_por_empresas_que_presten_servici: NO en top-10 · global 35 de 50 (top-50 del harness)
    - Restriccion_las_posiciones_arancelarias_de_los_bienes_no_correspondan_a_aquellas_comprendida: NO en top-10 · global — de 50 (top-50 del harness)
    - Restriccion_posiciones_arancelarias_ncm_8802_11_00_8802_12_10_8802_12_90_8802_20_10_8802_20_: NO en top-10 · global — de 50 (top-50 del harness)
    - EntidadFinanciera_empresa_de_aeronavegacion: NO en top-10 · global — de 50 (top-50 del harness)
    - Operacion_importacion_de_bienes_aeronaves: NO en top-10 · global 14 de 50 (top-50 del harness)

- **paso 11** — `aeronave NCM 8802 pago a la vista registro ingreso aduanero pendiente` · límite 10:
    - Excepcion_quedan_exceptuadas_las_importaciones_realizadas_por_empresas_que_presten_servici: NO en top-10 · global — de 50 (top-50 del harness)
    - Restriccion_las_posiciones_arancelarias_de_los_bienes_no_correspondan_a_aquellas_comprendida: NO en top-10 · global — de 50 (top-50 del harness)
    - Restriccion_posiciones_arancelarias_ncm_8802_11_00_8802_12_10_8802_12_90_8802_20_10_8802_20_: NO en top-10 · global 21 de 50 (top-50 del harness)
    - EntidadFinanciera_empresa_de_aeronavegacion: NO en top-10 · global — de 50 (top-50 del harness)
    - Operacion_importacion_de_bienes_aeronaves: NO en top-10 · global — de 50 (top-50 del harness)

**Lectura factual:** la excepción de aeronavegación es D1-negativa (mejor_rank 25, 0 consultas en top-10 de 105 simuladas) y no entró a ningún top-N en los pasos consultados; los dos nodos alcanzables de la familia son el listado 8802 (visto: posición 7 en el paso 2) y la Operación de importación de aeronaves.
