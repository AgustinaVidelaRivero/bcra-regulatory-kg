# Pre-registro de la fase A.2 — predicciones por brazo · **v3**
...
## 0. Por qué hay una v3, y qué se conserva

Las **tres** versiones se conservan integras en el paquete de revision, con su
sha; ninguna se edita:
...
| **v3** | *(sha impreso en el freno)* | **vigente** |

Que tres versiones se sucedan **antes** de medir no debilita el pre-registro:
lo que lo destruiria es editarlo **despues** de ver resultados. Nada se ha
corrido todavia.

### 0.a Por qué hay una v3 (cambio ANGOSTO sobre la v2)
