...
| GATE-03 | v1 | ext:7.4 | incorrecto | alcanzabilidad | alcanzabilidad | True | False | False | True | True | True | PASS |
...
| GATE-06 | v1 | ext:6.11 | parcial | generacion | generacion | True | False | True | True | True | True | PASS |
...
| GATE-09 | v1 | ext:6.11 | incorrecto | generacion | vista_no_consultada | True | True | False | True | True | True | PASS (detectado como no atribuible) |
| GATE-10 | v1 | ext:10.1 | incorrecto | generacion | generacion | True | True | True | True | True | True | PASS |
| GATE-11 | v2 | ext:6.11 | parcial | generacion | generacion | True | False | True | False | False | True | FAIL |

## Determinismo del adaptador

- re-adaptación desde la rebanada cruda: `ok = True` sobre 11 trazas (comparación byte a byte del JSON canónico salvo `meta.generado`)
- diferencias: []
