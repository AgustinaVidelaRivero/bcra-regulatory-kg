...
- CQ-038: respondible=[False, False, False] | abstencion modal=correcta (unánime=False); especulacion modal=True (dist={'true': 2, 'false': 1})
- CQ-039: respondible=[False, False, False] | abstencion modal=correcta (unánime=True); especulacion modal=False (dist={'false': 3})

## Trazas de muestra
- (factual limpia) CQ-002 (factual_directa): correctitud=correcta, completitud=completa, cita_documento_correcto=True, cita_precision=pagina | rep1 cost=$0.0250
- (más conflictiva) CQ-017 (multi_norma): correctitud=incorrecta*, completitud=parcial*, cita_documento_correcto=True, cita_precision=punto | rep1 cost=$0.0683
